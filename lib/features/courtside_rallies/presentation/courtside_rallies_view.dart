...
class CourtsideCircleInvitationsPage extends StatefulWidget {
  const CourtsideCircleInvitationsPage({required this.requests, super.key});

  final List<CourtsideCircleInvitation> requests;

  @override
  State<CourtsideCircleInvitationsPage> createState() =>
      _CourtsideCircleInvitationsPageState();
}

class _CourtsideCircleInvitationsPageState
    extends State<CourtsideCircleInvitationsPage> {
  late List<CourtsideCircleInvitation> _requests;

  @override
  void initState() {
    super.initState();
    _requests = List<CourtsideCircleInvitation>.of(widget.requests);
  }
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _FriendRequestRow(
                    request: request,
                    onFollow: () => _toggleFollow(request.invitationId),
                  );
                },
                separatorBuilder: (context, index) =>
